...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1783117293);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1783117293);
user_pref("app.update.lastUpdateTime.region-update-timer", 1783117293);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1783117293);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1783117324);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1783117293);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "standard");
user_pref("browser.download.viewableInternally.typeWasRegistered.avif", true);
user_pref("browser.download.viewableInternally.typeWasRegistered.webp", true);
user_pref("browser.migration.version", 150);
user_pref("browser.newtabpage.activity-stream.impressionId", "{335d48f6-8729-4a64-8ff0-abe552f241f6}");
...
user_pref("browser.startup.lastColdStartupCheck", 1783117264);
...
user_pref("captchadetection.lastSubmission", 1783117);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECEnLyrxah40KBAiiqrlwpmNuLg==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"16d4a8b5-61a2-4fe5-90b8-2021071e4470\",\"pictureinpicture@mozilla.org\":\"e468c4e4-44d4-47a0-8df1-54cb0824fbe9\",\"screenshots@mozilla.org\":\"0dd9abd4-6a52-42e1-9ec6-c17fb135a8dd\",\"webcompat@mozilla.org\":\"dc1d3e7f-4cc8-498e-923d-3f5299d977cf\",\"firefox-compact-dark@mozilla.org\":\"18c30df7-5d84-4afb-b5f2-af8ae002a3dc\",\"addons-search-detection@mozilla.com\":\"bb69db3b-95b8-485e-926f-4110276c0e68\",\"uBlock0@raymondhill.net\":\"65856caf-2838-41da-a276-bd2aeca381b9\"}");
...
user_pref("media.gmp-manager.lastCheck", 1783117305);
user_pref("media.gmp-manager.lastEmptyCheck", 1783117305);
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECGGOM3/lANMnBAhMxRZIQ1fL+Q==");
user_pref("toolkit.startup.last_success", 1783117263);
