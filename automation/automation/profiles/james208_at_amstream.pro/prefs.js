...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1783116553);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1783116553);
user_pref("app.update.lastUpdateTime.region-update-timer", 1783116553);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1783116553);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1783116586);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1783116553);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "standard");
user_pref("browser.download.viewableInternally.typeWasRegistered.avif", true);
user_pref("browser.download.viewableInternally.typeWasRegistered.webp", true);
user_pref("browser.migration.version", 150);
user_pref("browser.newtabpage.activity-stream.impressionId", "{2d6cebb1-3c2e-4384-a936-61b6a9cc93d0}");
...
user_pref("browser.startup.lastColdStartupCheck", 1783116864);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECKxItRK0deh9BAgVncEkZ2rakA==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"ce58b569-cee6-4fe7-a824-8e5d958584a0\",\"pictureinpicture@mozilla.org\":\"e0499f1c-66c5-4472-ba4c-aa24eb59e9bf\",\"screenshots@mozilla.org\":\"1394c518-6a15-440f-a2c0-3d0bf58fe907\",\"webcompat@mozilla.org\":\"30e9229e-639f-402a-8ca9-500dff8f798a\",\"firefox-compact-dark@mozilla.org\":\"359d6bf5-7ab2-4938-b863-a67cb308dd5d\",\"uBlock0@raymondhill.net\":\"1396ed3d-0fb4-4a7f-a2c6-bff9bcf850db\",\"addons-search-detection@mozilla.com\":\"a0d18690-24b0-4ec7-bf65-30f070b7fd20\"}");
...
user_pref("media.gmp-manager.lastCheck", 1783116553);
user_pref("media.gmp-manager.lastEmptyCheck", 1783116553);
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECEhatAcrViicBAhc/gAAHHpIXw==");
user_pref("toolkit.startup.last_success", 1783116863);
