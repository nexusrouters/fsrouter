...
export const OAUTH_PROVIDERS = {
  ...
  "nous-research": { id: "nous-research", alias: "nous", name: "Nous Research", icon: "hub", color: "#2563EB", textIcon: "NO", logo: "https://web-assets.nousresearch.com/portal/390f48a787363db9faefc02c15ef6f4c46f3f30d/assets/hermes-landing/nous.webp", website: "https://portal.nousresearch.com", notice: { text: "Free tier: 50 RPM, 500K TPM — no credit card. Sign in with your Nous Portal account (device login, no API key needed).", signupUrl: "https://portal.nousresearch.com" }, serviceKinds: ["llm"], authModes: ["oauth"], hasOAuth: true },
