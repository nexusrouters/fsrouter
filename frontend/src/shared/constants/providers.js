...
export const FREE_TIER_PROVIDERS = {
  ...
  nvidia: { id: "nvidia", alias: "nvidia", name: "NVIDIA NIM", icon: "developer_board", color: "#76B900", textIcon: "NV", website: "https://developer.nvidia.com/nim", notice: { text: "Free access for NVIDIA Developer Program members (prototyping & testing).", apiKeyUrl: "https://build.nvidia.com/settings/api-keys" }, serviceKinds: ["llm", "tts", "embedding", "rerank"], ttsConfig: { baseUrl: "https://integrate.api.nvidia.com/v1/audio/speech", authType: "apikey", authHeader: "bearer", format: "nvidia-tts", models: [{ id: "fastpitch", name: "FastPitch" }, { id: "tacotron2", name: "Tacotron2" }] }, embeddingConfig: { baseUrl: "https://integrate.api.nvidia.com/v1/embeddings", authType: "apikey", authHeader: "bearer", models: [{ id: "nvidia/nv-embedqa-e5-v5", name: "NV EmbedQA E5 v5", dimensions: 1024 }] } },
...
export const OAUTH_PROVIDERS = {
  ...
  zcode: { id: "zcode", alias: "zcode", name: "ZCode (Z.ai)", icon: "code", color: "#4F46E5", textIcon: "ZC", website: "https://zcode.z.ai", notice: { text: "Login dengan akun Z.ai / ZCode OAuth untuk mengakses model GLM-5.", signupUrl: "https://chat.z.ai" }, serviceKinds: ["llm"], authModes: ["oauth"], hasOAuth: true },
  "nous-research": { id: "nous-research", alias: "nous", name: "Nous Research", icon: "hub", color: "#2563EB", textIcon: "NO", logo: "/providers/nous-research.webp", website: "https://portal.nousresearch.com", notice: { text: "Free tier: 50 RPM, 500K TPM — no credit card. Sign in with your Nous Portal account (device login, no API key needed).", signupUrl: "https://portal.nousresearch.com" }, serviceKinds: ["llm"], authModes: ["oauth"], hasOAuth: true },
...
export const APIKEY_PROVIDERS = {
  ...
  "ibm-bob": { id: "ibm-bob", alias: "ib", name: "IBM Bob", icon: "psychology", color: "#0F62FE", textIcon: "IB", website: "https://bob.ibm.com", notice: { text: "Use your IBM Cloud IAM API Key.", signupUrl: "https://bob.ibm.com", apiKeyUrl: "https://cloud.ibm.com/iam/apikeys" } },
  ...
  openvecta: { id: "openvecta", alias: "ov", name: "OpenVecta", icon: "hub", color: "#7C3AED", textIcon: "OV", website: "https://openvecta.com", notice: { apiKeyUrl: "https://openvecta.com" }, serviceKinds: ["llm"] },
  ...
  digitalocean: { id: "digitalocean", alias: "do", name: "DigitalOcean", icon: "cloud", color: "#0069FF", textIcon: "DO", website: "https://www.digitalocean.com", notice: { apiKeyUrl: "https://cloud.digitalocean.com/account/api/tokens" }, serviceKinds: ["llm"], passthroughModels: true },
  ...
  cohere: { id: "cohere", alias: "cohere", name: "Cohere", icon: "hub", color: "#39594D", textIcon: "CO", website: "https://cohere.com", notice: { apiKeyUrl: "https://dashboard.cohere.com/api-keys" }, serviceKinds: ["llm", "embedding", "rerank"] },
  ...
  meta: { id: "meta", alias: "meta", name: "Meta AI", icon: "hub", logo: "/providers/meta.png", color: "#0064E0", textIcon: "M", website: "https://www.meta.ai", notice: { apiKeyUrl: "https://www.meta.ai/api/", text: "Meta AI API (api.meta.ai). Model: muse-spark-1.1." }, serviceKinds: ["llm"], authModes: ["apikey"], llmConfig: { baseUrl: "https://api.meta.ai/v1/chat/completions", authType: "apikey", authHeader: "bearer" }, models: [{ id: "muse-spark-1.1", name: "Muse Spark 1.1" }] },
};
...
export const MEDIA_PROVIDER_KINDS = [
  ...
  { id: "moderation",  label: "Moderation",     icon: "shield",            endpoint: { method: "POST", path: "/v1/moderations" } },
