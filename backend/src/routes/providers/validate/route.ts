...
import { resolveOllamaLocalHost, resolveXiaomiTokenplanBaseUrl, PROVIDERS } from '../../../../dist/open-sse/config/providers.js';
import { openaiToCommandCodeRequest } from '../../../../dist/open-sse/translator/request/openai-to-commandcode.js';
