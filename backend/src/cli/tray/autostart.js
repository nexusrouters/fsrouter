...
const APP_LABEL = "com.fsrouter.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when fsrouter is currently
 ...
 * SIGTERM to the running process. When the running fsrouter cli.js was itself
...
<dict>
    ...
    <string>/tmp/fsrouter.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/fsrouter.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `fsrouter.cmd` lookup that depended on the npm prefix path.
