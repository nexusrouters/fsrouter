...
export const APIKEY_PROVIDERS = {
  ...
  kimchi: { id: "kimchi", alias: "kimchi", name: "Kimchi", icon: "local_dining", color: "#FF6B35", textIcon: "KC", website: "https://kimchi.dev", notice: { apiKeyUrl: "https://app.kimchi.dev/settings" }, serviceKinds: ["llm", "webSearch"], searchConfig: { baseUrl: "https://llm.kimchi.dev/v1/search", authType: "apikey", authHeader: "bearer", format: "openai", timeoutMs: 25000 } },
