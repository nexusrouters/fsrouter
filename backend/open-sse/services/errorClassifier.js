/**
 * errorClassifier.js — Classifies upstream errors for routing decisions.
 * Handles: account deactivation, credits exhausted, daily quota, OAuth invalid, etc.
 */
...
export function isEmptyContentResponse(responseBody) {
...
export function isContextOverflow(errorText) {
...
export function classifyProviderError(statusCode, responseBody, provider) {
