...
const gamificationTools = [
  {
    ...
    handler: async (args) => {
      const { getTopN } = await import('../../../lib/gamification/leaderboard.js');
  ...
  },
  {
    ...
    handler: async (args) => {
      const { getRank } = await import('../../../lib/gamification/leaderboard.js');
  ...
  },
  {
    ...
    handler: async (args) => {
      const { getXp, getBadges } = await import('../../../lib/db/gamification.js');
      const { calculateLevel, getLevelTitle, getLevelTier } = await import('../../../lib/gamification/xp.js');
      const { getStreak } = await import('../../../lib/gamification/streaks.js');
  ...
  },
  {
    ...
    handler: async (args) => {
      const { getBadgeDefinitions, getBadges } = await import('../../../lib/db/gamification.js');
      if (args.apiKeyId) {
        const badges = getBadges(args.apiKeyId);
  ...
  },
  {
    ...
    handler: async (args) => {
      const { transferTokens } = await import('../../../lib/gamification/sharing.js');
  ...
  },
  {
    ...
    handler: async (args) => {
      const { createInvite } = await import('../../../lib/gamification/invites.js');
  ...
  },
  {
    ...
    inputSchema: z.object({}),
    handler: async () => {
      const { listServers } = await import('../../../lib/gamification/servers.js');
  ...
  },
  {
    ...
    inputSchema: z.object({}),
    handler: async () => {
      const { getAnomalies } = await import('../../../lib/gamification/antiCheat.js');
