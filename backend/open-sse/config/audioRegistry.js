 ...
 */
export const AUDIO_TRANSLATION_PROVIDERS = {
  openai: {
    id: "openai",
 ...
 */
export function buildDynamicAudioProvider(node, audioPath) {
...
function parseAudioModel(modelStr, registry, dynamicProviders) {
...
export function parseTranscriptionModel(modelStr, dynamicProviders) {
  return parseAudioModel(modelStr, AUDIO_TRANSCRIPTION_PROVIDERS, dynamicProviders);
}

export function parseSpeechModel(modelStr, dynamicProviders) {
  return parseAudioModel(modelStr, AUDIO_SPEECH_PROVIDERS, dynamicProviders);
}

export function parseTranslationModel(modelStr, dynamicProviders) {
