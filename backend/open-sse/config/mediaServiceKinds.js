...
import { SEARCH_PROVIDERS } from "./searchRegistry.js";
import { MODERATION_PROVIDERS } from "./moderationRegistry.js";
import { RERANK_PROVIDERS } from "./rerankRegistry.js";
...
export const REGISTRY_MEDIA_KINDS = Object.freeze(
 ...
 */
export function getRegistryMediaKinds(providerId) {
  const kinds = [];
 ...
 */
export function resolveProviderServiceKinds(providerId, declared) {
